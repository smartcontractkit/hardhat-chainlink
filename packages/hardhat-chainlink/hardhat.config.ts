...
const config: HardhatUserConfig = {
  ...
  typechain: {
    ...
    externalArtifacts: [
      ...
      "./node_modules/@chainlink/contracts/abi/v0.8/KeeperRegistry1_2.json",
      "./node_modules/@chainlink/contracts/abi/v0.8/KeeperRegistry1_3.json",
      "./node_modules/@chainlink/contracts/abi/v0.8/KeeperRegistry2_0.json",
      "./node_modules/@chainlink/contracts/abi/v0.8/KeeperRegistrar.json",
      "./node_modules/@chainlink/contracts/abi/v0.8/KeeperRegistrar2_0.json",
      ...
      "./node_modules/@chainlink/contracts/abi/v0.8/TypeAndVersionInterface.json",
